                            ...
                            <DialogContent className="sm:max-w-[445px]">
                                <DialogHeader>
                                    <div className="border border-neutral-300 rounded-xl py-5 px-6 bg-white space-y-5">
                                        ...
                                        <div>
                                            <div className="text-sm font-medium">Challenge Notes</div>
                                        ...
                                        <div className="flex gap-[10px] justify-between">
                                            <div className="w-1/2 py-1 px-4 flex justify-center items-center border border-neutral-300 rounded-md">Cancel</div>
