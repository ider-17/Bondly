...
export default function EventsThisWeek() {
    ...
    const events: Event[] = [
        {
            ...
            icon: <CalendarDays size={24} color='#14B8A6' />,
            bgColor: 'bg-teal-100',
        },
        {
            id: '2',
        ...
        },
        {
            ...
            icon: <BadgeQuestionMark size={24} color='#14B8A6' />,
            bgColor: 'bg-teal-100',
        },
        {
            id: '4',
            ...
            icon: <BadgeAlert size={24} color='#06B6D4' />,
            bgColor: 'bg-cyan-100',
        },
        {
            id: '5',
            ...
            icon: <svg width="24" height="24" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className='Events rounded-xl border border-neutral-300 py-5 px-6 space-y-5'>
            ...
            {events.map((event) => (
                <div key={event.id} className='w-full'>
                    ...
                    <div className='flex gap-4 py-[10px]'>
                        <div className={`w-12 h-12 rounded-lg flex justify-center items-center ${event.bgColor}`}>
                            {event.icon}
                        </div>
