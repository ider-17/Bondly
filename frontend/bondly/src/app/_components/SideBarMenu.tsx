import { BookOpen, ChevronRight, HeartHandshake, House, LogOut, Mountain } from 'lucide-react'
            ...
            <div className='space-y-3'>
                ...
                <div>
                    ...
                    <div className='w-full'>
                        <div className='w-full bg-slate-200 p-2 rounded-md flex gap-2 justify-between items-center'>
                        ...
                        <div className='w-full bg-white p-2 rounded-md flex gap-2 justify-between items-center'>
                            <div className='flex gap-2 items-center'>
                                <Mountain size={16} />
                                <p>Challenges</p>
                            </div>
